...
<div id="errorModal2" class="modal">
    <div class="modal-content">
    <br>
    <p>please try another valid Email for Registeration</p>
    <br><br>
    <button class="close-btn" onclick="closeModal2()">OK</button>
    </div>
</div>
    <script>
    ...
    <header class="header">
        ...
        <a href="#category" class="nav-item">Categories</a>
            <a onclick="showSignForm()"  class="nav-item">Products</a>
        ...
        <div class="user-profile">
            ...
            <a onclick="showSignForm()" class="sign-button" title="Sign in">Sign</a> 
        <!--lanpage content-->
    </header>
    <div class="Top-page">
    ...
    <section id="category">
        ...
        <div class="flex-home">
            <div class="card-review">
                <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/731d117dd75b9a91162920bc3ba907b9fabfc204dd56f39d028aaf7716ec0830?apiKey=40de46fc06df41429ee19f81541162c6&"
                    class="image-category" alt="bathroom image" />
                <button onclick="showSignForm()" class="btn" type="button">Restroom</button>
            </div>
            <div class="card-review">
                <img src="https://i.pinimg.com/736x/0a/6a/bf/0a6abfc987572b001365cda15b78c367.jpg" alt="chair category"
                    class="image-category">
                <button onclick="showSignForm()" class="btn" type="button">Chairs</button>
            </div>
            <div class="card-review">
                <img src="https://i.pinimg.com/564x/0c/7a/ee/0c7aee620345839ebce549b6c6e6ef81.jpg" alt="lamps category"
                    class="image-category">
                <button onclick="showSignForm()" class="btn" type="button">Lamps</button>
            </div>
            <div class="card-review">
                <img src="https://i.pinimg.com/564x/0c/68/5d/0c685de044fbc50168b9b5df2da405fe.jpg"
                    alt="dinning category" class="image-category">
                <button onclick="showSignForm()" class="btn" type="button">Dinning room</button>
            </div>
            <div class="card-review">
                <img src="https://i.pinimg.com/564x/6c/20/9a/6c209afda9fc1b8228f17f5a37c8c9e2.jpg"
                    alt="bedroom category" class="image-category">
                <button onclick="showSignForm()" class="btn" type="button">Bedroom</button>
            </div>

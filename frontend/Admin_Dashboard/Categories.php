  ...
  <body>
    ...
    <div id="sidebar" class="sidebar">
      ...
      <ul>
        ...
        <!-- Categories -->
        <li class="checked-li"><a href="Categories.php"><i class="fa fa-list"></i> Categories</a></li>
        <!-- Products -->
    ...
    <div id="main" class="main">
      ...
      {
      ?>
      <!-- Initial content(To Add Category) -->
      <div id="content" class="content">
        ...
        <div class="overview">
          ...
          <div class="a_card_dialog" id="myModal">
            ...
            <form action="../../backend/category.php" method="post" enctype="multipart/form-data" class="P_form">
              <div class="P_form-group">
                <label class="P_label">Category:</label>
                <input type="text" name="name" required="" class="P_input">
              </div>
              <br>
              <div class="P_form-group">
                <input type="submit" value="Add Category" class="P_submit">
              </div>
            </form>
          ...
          <div class="a_card_dialog" id="myEdit">
            <div class="flex">
                ...
                <h3>Edit Category no. <label for=""id="number"></label> <h3>
                
                <span class="close" onclick="closeEdit()">&times;</span>

            </div>
            <form id="myForm" action="../../backend/category.php" method="post" enctype="multipart/form-data" class="P_form">
              <div class="P_form-group">
                <label class="P_label">Category New Name:</label>
                <input type="text" name="edit_name" required="" class="P_input">
                <input type="hidden" name="number" id="numberInput">
                <input type="hidden" name="source" value="edit">
              </div>
              <br>
              <div class="P_form-group">
                <input type="submit" value="Update Category" class="P_submit">
              </div>
            </form>
      ...
      ?>
        ...
        <div class="tttt">
            <table>
                ...
                <tbody>
                    <?php
                    include_once '../../../furniture/backend/category.php';
                    if (count($categories)>0) {
                        foreach ($categories as $category) {
                            ...
                            echo "<td>" . $category["modified_at"] . "</td>";
                            echo "<td>";
                            $id= $category["id"];
                            echo "<button onclick='openEdit($id)' class='Agree'>Edit</button>";
                            echo" 
                          <form action='../../../furniture/backend/category.php' method='post'>
                        ...
                        echo "<tr><td colspan='5'>No Categories Stored to display</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
